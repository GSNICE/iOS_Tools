...
#pragma mark - 加半透明水印
+ (UIImage *)addImage:(UIImage *)useImage addMainImage:(UIImage *)mainImage addMsakImage:(UIImage *)maskImage withMainImage:(CGRect)mainRect withMaskRect:(CGRect)rect
{
...
////        UIGraphicsBeginImageContextWithOptions(CGSizeMake(SCREEN_WIDTH, useImage.size.height/(useImage.size.width/SCREEN_WIDTH)), NO, 0.0);
////        UIGraphicsBeginImageContextWithOptions(CGSizeMake(useImage.size.width/2, useImage.size.height/2), NO, 0.0);
//    }
//#else
//    if ([[[UIDevice currentDevice] systemVersion] floatValue] < 4.0)
//    {
