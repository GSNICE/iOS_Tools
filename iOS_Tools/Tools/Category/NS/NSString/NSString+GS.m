...
#pragma mark - 计算富(有间距)文本的 NSString 高度
...
#pragma mark - font 字体的文本大小
- (CGSize)sizeWithFont:(UIFont *)font
{
    return [self sizeWithFont:font maxW:MAXFLOAT];
}

#pragma mark - 适合的高度 默认 systemFontOfSize:font
...
#pragma mark - 适合的宽度 默认 systemFontOfSize:font
...
#pragma mark - YYYY-MM-dd HH:mm:ss对应的 NSDate
- (NSDate *)date__YMdHMS
{
    if (!YYYYMMddHHmmss) {
...
#pragma mark - YYYY-MM-dd 对应的 NSDate
- (NSDate *)date__YMd
{
    if (!YYYYMMdd) {
...
#pragma mark - 转为 base64string 后的 NSData
- (NSData *)base64Data
{
    return [[NSData alloc] initWithBase64EncodedString:self options:0];
}

#pragma mark - 转为 base64String
- (NSString *)base64Str
{
...
#pragma mark - 解 base64为Str 解不了就返回原始的数值
...
#pragma mark - 拼接 intValue
- (NSString *)addInt:(int)intValue
{
    return [self stringByAppendingString:@(intValue).stringValue];
}

#pragma mark - 32位MD5加密(小写：%02x；大写：%02X)
- (NSString *)MD5
{
...
#pragma mark - SHA1加密(小写：%02x；大写：%02X)
- (NSString *)SHA1
{
    const char *cStr = [self UTF8String];
...
@implementation NSDictionary (GS)

#pragma mark - 字典 转为 JsonStr
- (NSString *)jsonStr
{
